...
const MAX31855_EXTTEMPCONFIG = { mask: 0x7ffc0000, shift: 18, gain: 0.25, offset: -0.0};
...
const ROC_PARAM = {
  WAIT: {THRESHOLD_TEMP: 0.0, TIMELIMIT: 0, PWMCYCLE: 10, PWMON: 10, DISSIPATION_DETECT: false},
